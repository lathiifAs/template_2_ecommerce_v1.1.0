...
if (! function_exists('ro_get_provinsi')) {
        function ro_get_provinsi()
        {
            $curl = curl_init();
            ...
            CURLOPT_HTTPHEADER => array(
                "key: 1be3c9fd78b73185cf4122c812196541"
            ),
            ));
...
if (! function_exists('ro_get_kabupaten_by_prov')) {
     //raja ongkir
    function ro_get_kabupaten_by_prov($prov_id='')
     {
...
if (! function_exists('ro_get_kabupaten_by_prov')) {
    //raja ongkir
    function ro_get_kecamatan_by_kab($kab_id='')
    {
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://pro.rajaongkir.com/api/subdistrict?city=$kab_id",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
...
if (! function_exists('ro_get_kabupaten_by_prov')) {
    function ro_get_onkir($asal, $tujuan, $berat, $kurir)
    {
...
if (! function_exists('ro_get_kabupaten_by_prov')) {
    ...
    function ro_cek_resi($resi, $kurir)
    {
            $curl = curl_init();
            curl_setopt_array($curl, array(
