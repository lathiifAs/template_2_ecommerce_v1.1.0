...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
  ...
  <!-- swiper js -->
  <script src="<?php echo e(base_url('assets/client_template/js/lightslider.min.js')); ?>"></script>
  <!-- swiper js -->
  <script src="<?php echo e(base_url('assets/client_template/js/mixitup.min.js')); ?>"></script>
  <script src="<?php echo e(base_url('assets/client_template/js/lightslider.min.js')); ?>"></script>
  <!-- particles js -->
